...
wget http://download.pytorch.org/whl/cu80/torch-0.2.0.post3-cp36-cp36m-macosx_10_7_x86_64.whl
python -m pip install torch-0.2.0.post3-cp36-cp36m-macosx_10_7_x86_64.whl
